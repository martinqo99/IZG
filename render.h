 ...
 * spanel@fit.vutbr.cz
 *
 * $Id: render.h 264 2013-02-20 12:27:25Z spanel $
 *
 * Opravy a modifikace:
 * -
 */
...
/* ukazatel na funkci pro vykresleni cary zadanou barvou */
typedef void (* F_projectLine)(S_Renderer *pRenderer, S_Coords *p1, S_Coords *p2, S_RGBA color);
...
struct S_Renderer
{
    ...
    F_projectLine       projectLineFunc;        /* vykresleni cary */
...
/* Vykresli usecku zadanou barvou
 * Pred vykreslenim aplikuje na koncove body usecky aktualne nastavene
 * transformacni matice!
 * p1, p2 - koncove body ve 3D prostoru
