 ...
 * spanel@fit.vutbr.cz
 *
 * $Id: main.c 267 2013-02-20 18:48:51Z spanel $
 *
 * *) Ovladani programu:
 ...
 * - 2013/02/23 (MS, xkonam00): oprava timer callbacku pro 64bit kompilaci
 */
...
const char         * PROGRAM_TITLE = "IZG/2012 Project";

/* titulek hlavniho okna je-li zapnuty studentsky renderer */
const char         * PROGRAM_TITLE_STUDENT = "IZG/2012 Project -- Student";
...
void draw(void)
{
    ...
    /* prekreslit scenu!!! */
    renderScene(renderer, polymodel);
